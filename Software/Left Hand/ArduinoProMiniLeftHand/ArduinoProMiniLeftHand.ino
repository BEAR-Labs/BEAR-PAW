...
//Setup the servo PWM (SIG) wire attachement corresponding to the board pins
  servo_1.attach(PWM_1, 1000, 2000); //(pin, min, max) min,max of servo 1000, 2000 us, from data sheet
  servo_1.write(0); //180               //set each position to zero position upon turning on (this motor is fliped)
  servo_2.attach(PWM_2, 1000, 2000);
  servo_2.write(180); // 0
  servo_3.attach(PWM_3, 1000, 2000);
  servo_3.write(180); //0               //This motor is fliped
  servo_4.attach(PWM_4, 1000, 2000);
  servo_4.write(0);  //180              //This motor is fliped
  servo_5.attach(PWM_5, 1000, 2000);
  servo_5.write(0); //180               //This motor is fliped
  servo_6.attach(PWM_6, 1000, 2000);
  servo_6.write(0); // 180                //This motor is fliped
...
if(val == G_2){ // This is the same thing, it's redundant
  int val_1 = 150;  //Thumb //int val_1 = 110;  //Thumb
...
if(val == G_4){ // This is the same thing, it's redundant
  int val_1 = 110;  //Thumb //int val_1 = 110;  //Thumb
  int val_2 = 0;  //Thumb Opposition
  int val_3 = 50; //Index
  int val_4 = 130;   //Middle
  int val_5 = 110;   //Ring
  int val_6 = 110;   //Little
...
if(val == G_7){
  int val_1 = 50;  //Thumb
  int val_2 = 0;  //Thumb Opposition
  int val_3 = 150; //Index   // 30 deg
  int val_4 = 50;   //Middle // 30 deg
  int val_5 = 30;   //Ring   // 30 deg
  int val_6 = 30;   //Little // 30 deg
...
if(val == G_8){
  int val_1 = 160;  //Thumb //int val_1 = 110;  //Thumb
  int val_2 = 0;  //Thumb Opposition
  int val_3 = 0; //Index
  int val_4 = 180;   //Middle
  int val_5 = 180;   //Ring
...
if(val == D_1){
    ...
    delay(150);
    servo_4.write(0);
    servo_6.write(90);//added
    delay(50);
    servo_3.write(180);
    delay(50);        //added
    servo_5.write(90);//added
    delay(100);
    servo_6.write(0);
    servo_4.write(90);
    delay(100);
