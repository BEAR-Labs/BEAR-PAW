...
//Setup the servo PWM (SIG) wire attachement corresponding to the board pins
  ...
  servo_6.write(0); //180               //set each position to zero position upon turning on (this motor is fliped)
  servo_5.attach(PWM_2, 1000, 2000);
  servo_5.write(180); // 0
  servo_4.attach(PWM_3, 1000, 2000);
  servo_4.write(180); //0               //This motor is fliped
  servo_3.attach(PWM_4, 1000, 2000);
  servo_3.write(0);  //180              //This motor is fliped
  servo_2.attach(PWM_5, 1000, 2000);
  servo_2.write(0); //180               //This motor is fliped
  servo_1.attach(PWM_6, 1000, 2000);
  servo_1.write(0); // 180                //This motor is fliped
