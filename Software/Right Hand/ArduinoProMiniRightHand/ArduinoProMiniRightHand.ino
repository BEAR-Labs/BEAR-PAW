...
//Setup the servo PWM (SIG) wire attachement corresponding to the board pins
  ...
  servo_1.write(180);                //set each position to zero position upon turning on (this motor is fliped)
  servo_2.attach(PWM_2, 1000, 2000);
  servo_2.write(0); 
  servo_3.attach(PWM_3, 1000, 2000);
  servo_3.write(0);                  //This motor is fliped
  servo_4.attach(PWM_4, 1000, 2000);
  servo_4.write(180);                //This motor is fliped
  servo_5.attach(PWM_5, 1000, 2000);
  servo_5.write(180);                //This motor is fliped
  servo_6.attach(PWM_6, 1000, 2000);
  servo_6.write(180);                //This motor is fliped
...
//  //Grasp 6: Writing Tripod
//if(val == G_6){
//  int val_1 = 40;  //Thumb
//  int val_2 = 120; //Thumb Opposition
//  int val_3 = 155; //Index
//  int val_4 = 0;   //Middle
//  int val_5 = 0;   //Ring
//  int val_6 = 0;   //Little
